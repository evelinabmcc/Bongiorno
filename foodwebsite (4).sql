...
--
-- Host: localhost:3306
-- Generation Time: May 07, 2021 at 07:27 PM
...
INSERT INTO `course` (`course_id`, `course_title`, `availability`, `image_name`) VALUES
(1, 'Brunch', 'Yes', 'None'),
(2, 'Lunch', 'Yes', 'None');
...
--
ALTER TABLE `course`
  MODIFY `course_id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `food`
  MODIFY `item_num` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
