<!-- 
    Authors: Ryan Paul, 
     ...
     Project: Admin Panel: 'add-category.php'
        ...
        <?php 
            ...
            if(isset($_POST['submit']))
            {
                ...
                if(isset($_FILES['image']['name']))
                {
                    ...
                    if($image_name != "")
                    {
                        ...
                        if($upload==false)
                        {
                            ...
                            header('location: http://localhost/bongiorno/admin/add-category.php');
                            //STop the Process
                            die();
                        }
                ...
                if($res==true)
                {
                    ...
                    header('location: http://localhost/bongiorno/admin/manage-category.php');
                }
                else
                {
