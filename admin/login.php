...
<html>
    ...
    <body>
        ...
        <div class="login">
            ...
            Username: <br>
            <input type="text" name="admin_username" placeholder="Enter Username"><br><br>
...
<?php 
    ...
    if(isset($_POST['submit']))
    {
        ...
        if($count==1)
        {
            ...
            $_SESSION['admin'] = $admin_username; //TO check whether the admin is logged in or not and logout will unset it
