<?php 
include('reusable-code-admin/navbar-section.php'); 
...
<?php 
    ...
    if(isset($_GET['item_num']))
    {
        ...
        $sql2 = "SELECT * FROM food WHERE item_num=$item_num";
        //execute the Query
        ...
        $featured_food = $row2['featured'];
        $active_food = $row2['active'];
    ...
    <div class="wrapper">
        ...
        <table class="tbl-30">
                ...
                <td>
                    <select name="course">
                        ...
                        <?php 
                            ...
                            //Check whether course available or not
                            if($count>0)
                            {
                                //Course Available
            ...
            <tr>
                <td>Featured: </td>
                <td>
                    <input <?php if($featured_food=="Yes") {echo "checked";} ?> type="radio" name="featured_food" value="Yes"> Yes 
                    <input <?php if($featured_food=="No") {echo "checked";} ?> type="radio" name="featured_food" value="No"> No 
                </td>
            </tr>
            ...
            <tr>
                <td>Active: </td>
                <td>
                    <input <?php if($active_food=="Yes") {echo "checked";} ?> type="radio" name="active_food" value="Yes"> Yes 
                    <input <?php if($active_food=="No") {echo "checked";} ?> type="radio" name="active_food" value="No"> No 
                </td>
            </tr>
        ...
        <?php 
            ...
            if(isset($_POST['submit']))
            {
                ...
                $featured_food = $_POST['featured_food'];
                $active_food = $_POST['active_food'];
